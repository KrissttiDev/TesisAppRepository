...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
      ...
      client: json['client'] is String ? clientFromJson(json['client']) : json['client'] is Client ? json['client'] : Client.fromJson(json['client'] ?? {}),
      delivery: json['delivery'] is String ? clientFromJson(json['delivery']) : json['delivery'] is Client ? json['delivery'] : Client.fromJson(json['delivery'] ?? {}),
