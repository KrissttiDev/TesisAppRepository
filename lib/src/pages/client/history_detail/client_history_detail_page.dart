...
import 'package:mi_flutter/src/pages/client/history_detail/client_history_detail_controller.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _listTileInfo('Hace', '${_con.travelHistory?.timestamp?.toString() ?? '0\$'} ', Icons.timer_outlined),
          ],
        ),
      ),
    );
