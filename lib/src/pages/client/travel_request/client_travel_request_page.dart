...
import 'package:mi_flutter/src/pages/client/travel_request/client_travel_request_controller.dart';
...
class ClientTravelRequestPage extends StatefulWidget {
  ...
  @override
  _ClientTravelRequstPageState createState() => _ClientTravelRequstPageState();
}

class _ClientTravelRequstPageState extends State<ClientTravelRequestPage> {
        ...
        child: Column(
         crossAxisAlignment: CrossAxisAlignment.center,
          ...
          children: [
            CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('assets/img/uber_profile.jpg'),
            ),
            Container(
