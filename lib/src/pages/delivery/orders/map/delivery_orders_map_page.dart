...
import 'package:mi_flutter/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
...
class _DeliveryOrdersMapPageState extends State<DeliveryOrdersMapPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          _listTileAddress(
              ...
              'Dirección: ',
              Icons.location_on),
         Divider(color: Colors.grey[400],endIndent: 25,indent: 25,),
          _clientInfo(),
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              '${_con.order?.client?.username??''} ${_con.order?.client?.lastname??''}',
              style:TextStyle(
                color: Colors.black,
                fontSize: 16,
              ),
  ...
  Widget _buttonNext(){
    return Container(
      margin: EdgeInsets.only(left: 30, right: 30,top:5, bottom: 2),
